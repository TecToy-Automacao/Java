package br.com.tectoy.tectoysunmi.activity.ExemploNFCIdRW;
...
import br.com.tectoy.tectoysunmi.activity.ExemploNFCIdRW.fragment.NFCFormatFragment;
import br.com.tectoy.tectoysunmi.activity.ExemploNFCIdRW.fragment.NFCReadFragment;
import br.com.tectoy.tectoysunmi.activity.ExemploNFCIdRW.fragment.NFCWriteFragment;
import br.com.tectoy.tectoysunmi.activity.ExemploNFCIdRW.fragment.NFCWriteReadFragment;
...
public class NfcExemplo extends AppCompatActivity {
    ...
    private static final String MENSAGEM_PADRAO = "TecToy";
    ...
    protected void onResume() {
        ...
        IntentFilter isMira = new IntentFilter(NfcAdapter.EXTRA_TAG);
        IntentFilter[] nfcIntentFilter = new IntentFilter[]{techDetected,tagDetected,ndefDetected, idDetected, isMira};
