...
public interface IStateLamp extends android.os.IInterface
{
  ...
  public static class Default implements woyou.aidlservice.jiuiv5.IStateLamp
  {
    /**
  ...
  public static abstract class Stub extends android.os.Binder implements woyou.aidlservice.jiuiv5.IStateLamp
  {
    private static final java.lang.String DESCRIPTOR = "woyou.aidlservice.jiuiv5.IStateLamp";
    ...
    /**
     * Cast an IBinder object into an woyou.aidlservice.jiuiv5.IStateLamp interface,
     * generating a proxy if needed.
     */
    public static woyou.aidlservice.jiuiv5.IStateLamp asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof woyou.aidlservice.jiuiv5.IStateLamp))) {
        return ((woyou.aidlservice.jiuiv5.IStateLamp)iin);
      }
      return new woyou.aidlservice.jiuiv5.IStateLamp.Stub.Proxy(obj);
    }
    ...
    private static class Proxy implements woyou.aidlservice.jiuiv5.IStateLamp
    {
      ...
      public static woyou.aidlservice.jiuiv5.IStateLamp sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(woyou.aidlservice.jiuiv5.IStateLamp impl) {
    ...
    public static woyou.aidlservice.jiuiv5.IStateLamp getDefaultImpl() {
